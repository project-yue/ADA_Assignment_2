 ...
 * @Author: Jiamou Liu
 */
public class Digraph extends JPanel implements MouseMotionListener,
	 ...
	 * representation The top line of the file contains the number n of nodes in
	 * the graph The nodes in the graph are then given the indices 0,...,n-1
	 *
	 */
			...
			case "print":
				try {
					...
					case "degrees":
						...
						break;
					case "size":
						System.out.println("Size of the digraph: "
								+ graphSize());
						break;
					case "order":
					...
					case "source":
						for (Integer i : nodeSet) {
							if (isUniversalSource(i)) {
								selectedNode = i;
								System.out.println("Universal Source found: "
										+ i);
								found = true;
								break;
							}
					...
					case "sink":
						for (Integer i : nodeSet) {
							if (isUniversalSink(i)) {
								selectedNode = i;
								System.out
										.println("Universal Sink found: " + i);
								found = true;
								break;
							}
						}
	...
	public void drawEdge(Integer node1, Integer node2, Graphics g,
			Color colorLine, Color colorArrow) {
